...
package com.chihiro.scrolllayout;

import android.app.Activity;
import android.content.Context;
import android.content.res.TypedArray;import android.os.Build;
...
public class ScrollLayout extends FrameLayout {
    ...
    private final ContentScrollView.OnScrollChangedListener mOnScrollChangedListener = new ContentScrollView.OnScrollChangedListener() {
        @Override
    ...
    public void scrollTo(int x, int y) {
        ...
        float progress;
        if (-y <= maxOffset) {
            progress = (float) (-y - minOffset) / (maxOffset - minOffset);
        } else {
            progress = (float) (-y - maxOffset) / (maxOffset - exitOffset);
        }
